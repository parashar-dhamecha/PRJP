...
import com.dxdevil.pd.prjp.Model.Response.Verify.VerifyDetails.Observer
import com.dxdevil.pd.prjp.R


class VerifyObserversAdapter(
    var list: List<Observer>, var context:Context): RecyclerView.Adapter<VerifyObserversAdapter.ViewHolder>() {
