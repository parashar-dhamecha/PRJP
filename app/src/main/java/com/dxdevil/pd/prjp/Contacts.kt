...
class Contacts : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        grp.setOnClickListener {
            ...
            r1!!.adapter = ContactsAdapter(applicationContext, contactList)
            r1.addItemDecoration(DividerItemDecoration(this,DividerItemDecoration.VERTICAL))
        }
        ...
        var call1 = api1.addcontactresponse(token2) as Call<AddContactResponse>
        call1?.enqueue(object : Callback<AddContactResponse> {
